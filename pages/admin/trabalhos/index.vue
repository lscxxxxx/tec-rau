    ...
    <div class="min-h-screen text-gray-800 font-sans flex flex-col">
        <main class="flex-1 max-w-6xl mx-auto w-full p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <UButton to="/admin/trabalhos/novo" icon="i-lucide-plus" class="uppercase text-[12.5px] font-semibold">
        ...
        <div v-show="isModalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50">
